        ...
        <div id="4" class="item new col-md-12">
            <a href="/book">
                <div class="course-item">
                    ...
                    <h5>Unit Standard: 6401</h5>
                    <h6>$149.00</h6>
                    <p>Individuals who meet the standards of this unit can provide basic cardiopulmonary resuscitation
                        (CPR).
                        The unit includes the emergency care phase: rapid identification or intervention to prevent
                        breathing
